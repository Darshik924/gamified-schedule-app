...
document.querySelectorAll(".difficulty-btn").forEach(btn=> {
    ...
    document.querySelectorAll(".difficulty-btn").forEach(b => b.classList.remove("bg-[#8b5cf6]", "text-white"));
...
function updateCounts() {
    ...
    activeTask.textContent = todoContainer.children.length + progressContainer.children.length;
}
